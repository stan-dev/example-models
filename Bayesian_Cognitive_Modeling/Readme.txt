...
All models are prepared for running from R using rstan. Model codes are included
in R scripts.

Here you can find all models for the first two parts of the book and more models
will be published here soon. If you can't wait for further models, contact me 
on the email address given above.

There is moderate chance that you'll find a mistake in the models, please let me
...
In the scripts for models from the first chapters you can find notes to the Stan
...
TO ADD
 ...
 - seznam modelu s poznamkami (jako moje tabulka)
 
????
 - should I mention copyright(na me jmeno?)/license?