...
transformed parameters {
  vector<lower=0,upper=1>[n_occasions-1] phi_1;   // First year survival prob.
  vector<lower=0,upper=1>[n_occasions-1] phi_2;   // Second year survival prob.
  vector<lower=0,upper=1>[n_occasions-1] phi_ad;  // Adult survival prob.
  vector<lower=0,upper=1>[n_occasions-1] alpha_1; // Prob. to start breeding when 1 yr old
  vector<lower=0,upper=1>[n_occasions-1] alpha_2; // Prob. to start breeding when 2 yr old
  vector<lower=0,upper=1>[n_occasions-1] p_NB;    // Recapture prob. of non-breeders
  vector<lower=0,upper=1>[n_occasions-1] p_B;     // Recapture prob. of breeders
  simplex[5] ps[5, nind, n_occasions-1];
  simplex[4] po[5, nind, n_occasions-1];
