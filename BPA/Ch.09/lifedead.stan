...
transformed parameters {
  vector<lower=0,upper=1>[n_occasions-1] s; // True survival probability
  vector<lower=0,upper=1>[n_occasions-1] F; // Fidelity probability
  vector<lower=0,upper=1>[n_occasions-1] r; // Recovery probability
  vector<lower=0,upper=1>[n_occasions-1] p; // Recapture/resighting probability
