...
functions {
   ...
   * @return m-array cell probabilities for juveniles
   */
  array[] vector marray_juveniles(int nyears, vector phij, vector phia,
                                  vector p) {
    int ny_minus_1 = nyears - 1;
    array[ny_minus_1] vector[nyears] pr_j;
...
data {
  ...
  array[nyears] int y; // Population counts
  array[nyears - 1] int J; // Productivity data
  array[nyears - 1] int R;
  array[nyears - 1, nyears] int marray_j; // Data in m-array format for juveniles
  array[nyears - 1, nyears] int marray_a; // Data in m-array format for adults
}
transformed data {
  int ny_minus_1 = nyears - 1;
}
...
transformed parameters {
  ...
  array[ny_minus_1] simplex[nyears] pr_j;
  array[ny_minus_1] simplex[nyears] pr_a;
