...
```{r install_edstan, message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r descriptives, tidy=TRUE, fig.show='hold', fig.keep='last'}
...
```{r fit_1, cache=TRUE, results='hide', message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r long_data, message=FALSE, tidy=TRUE}
...
```{r parameters_method, tidy=TRUE, results='hold'}
...
```{r multiple_icc, tidy=TRUE, fig.show='hold'}
...
```{r reg_centered_code, comment="",message=FALSE, cache=TRUE, echo=FALSE, warning=FALSE, tidy=FALSE}
...
```{r latent_reg, cache=TRUE, results='hide', message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r latent_reg_print, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r reg_noncentered_code, comment="",message=FALSE, cache=TRUE, echo=FALSE, warning=FALSE, tidy=FALSE}
...
```{r difcode, comment="",message=FALSE, cache=TRUE, echo=FALSE, warning=FALSE, tidy=FALSE}
...
```{r dif, cache=TRUE, results='hide', message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r dif_print, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r modify_data, echo = FALSE, evaluate = TRUE, tidy=TRUE}
...
```{r, results = "hide", cache = TRUE, tidy=TRUE}
...
stan_hist(troubleshoot_fit1b, pars = "alpha[4]") + geom_vline()
```
...
```{r, tidy=TRUE, cache=TRUE, results="hide"}
