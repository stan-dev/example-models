...
output:
  html_document:
    ...
    fig_caption: true
<<<<<<< HEAD:education/hierarchical_2pl/hierarchical_2pl.Rmd
    css: ../styles.css
...
bibliography: bibliography.bib
>>>>>>> 3bd1f0ba99f6590c190cec689fdec25ba41f6297:education/hierarchical_2pl.Rmd
---
...
```{r sim_fit, results='hide', warning=FALSE, message=FALSE}
...
```{r example_fit, cache=TRUE, results='hide', warning=FALSE, message=FALSE}
