...
* $\mu_2 \sim \mathrm{N}(0,9)$ is a weakly informative prior for the mean of the difficulty parameters.
...
sat_draws <- extract(sat_fit, permuted = FALSE, inc_warmup = TRUE)
sat_monitor <- as.data.frame(monitor(sat_draws, print = FALSE))
