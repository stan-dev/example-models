...
* $w_{j}$ is the vector of covariates for person $j$, which must include an intercept term
...
* $\beta_I = -\frac{1}{I-1} \sum_{i}^{(I-1)} \beta_i$
...
Third, positive discrimination parameters are assumed for identifiability.
