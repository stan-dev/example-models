...
simulated data and demonstrate the inference of contestan abilities
...
plarallel arrays of integers indicating the players in each match and
the outcome.
...
# Hierarcical Bayesian Bradley-Terry Model
