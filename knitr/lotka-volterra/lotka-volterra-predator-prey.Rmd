...
1.  *Missing data*.  Suppose that several of the measurements are missing.  Write a Stan program that uses only the observed measurements.  How robust is the fit to missing a few data points?  What happens to the computation and posterior inferences when most of the data is missing?
