...
This short case study shows how to use Stan to perform online A/B testing using multi-armed bandits (Robbins 1952).  Stan is used for Bayesian estimation and event probabilty estimation for probability matching (Thompson 1931).  We analyze both Bernoulli bandits and their natural extension to predictors with logistic regression.
