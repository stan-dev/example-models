...
case study explores the Thompson sampling pollicy (Thomspon 1931),
wherein a bandit is chosen at random with probability equal to its
posterior probability of providing the highest expected return. The
...
context-dependent rewards modeled with a generalized linear model.
